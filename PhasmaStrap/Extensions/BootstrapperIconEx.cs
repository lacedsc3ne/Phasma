...
namespace PhasmaStrap.Extensions
{
    static class BootstrapperIconEx
    {
        ...
        {
            BootstrapperIcon.IconPhasmaStrap,
            ...
            BootstrapperIcon.IconPhasmaStrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconPhasmaStrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconPhasmaStrap => Properties.Resources.IconPhasmaStrap,
                ...
                BootstrapperIcon.IconPhasmaStrapClassic => Properties.Resources.IconPhasmaStrapClassic,
                _ => Properties.Resources.IconPhasmaStrap
            };
        }
    }
}
