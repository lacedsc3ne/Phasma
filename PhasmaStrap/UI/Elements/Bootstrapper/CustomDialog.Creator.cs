...
namespace PhasmaStrap.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        {
            ["PhasmaStrapCustomBootstrapper"] = HandleXmlElement_PhasmaStrapCustomBootstrapper_Fake,
        ...
        private static void AssertThemeVersion(string? versionStr)
        {
            if (string.IsNullOrEmpty(versionStr))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotSet", "PhasmaStrapCustomBootstrapper");

            if (!uint.TryParse(versionStr, out uint version))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotNumber", "PhasmaStrapCustomBootstrapper");
        ...
        private void HandleXmlBase(XElement xml)
        {
            ...
            if (xml.Name != "PhasmaStrapCustomBootstrapper")
                throw new CustomThemeException("CustomTheme.Errors.InvalidRoot", "PhasmaStrapCustomBootstrapper");
